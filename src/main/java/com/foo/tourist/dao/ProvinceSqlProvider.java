...
import org.louis.hometutor.po.ProvinceExample.Criteria;
import org.louis.hometutor.po.ProvinceExample.Criterion;
...
public class ProvinceSqlProvider {
     ...
     * @mbggenerated
     */
    protected void applyWhere(ProvinceExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
