...
import org.louis.hometutor.po.DoctorExample.Criteria;
import org.louis.hometutor.po.DoctorExample.Criterion;
...
public class DoctorSqlProvider {
    ...
    public String selectByExample(DoctorExample example) {
        ...
        SELECT("\"title\"");
        SELECT("\"inviteCode\"");
        SELECT("\"authorityVerifyStatus\"");
        SELECT("\"phoneNo\"");
        SELECT("\"wechatId\"");
        SELECT("\"wechatNo\"");
        SELECT("\"bonusPoint\"");
        SELECT("\"email\"");
        SELECT("\"binaryCodeUrl\"");
        SELECT("\"birthday\"");
        SELECT("\"iconUrl\"");
        SELECT("\"no\"");
        SELECT("\"desc\"");
        SELECT("\"expertDisease\"");
        SELECT("\"hospitalSchedule\"");
        SELECT("\"netSchedule\"");
        SELECT("\"unSettlementedFee\"");
        SELECT("\"totalFee\"");
        SELECT("\"patientCount\"");
        SELECT("\"isSignDoctor\"");
        SELECT("\"sortOrder\"");
