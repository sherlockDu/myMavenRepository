...
import org.louis.hometutor.po.DeviceInfoExample.Criteria;
import org.louis.hometutor.po.DeviceInfoExample.Criterion;
...
public class DeviceInfoSqlProvider {
     ...
     * @mbggenerated
     */
    protected void applyWhere(DeviceInfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
