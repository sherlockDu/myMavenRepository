...
import org.louis.hometutor.po.CommentExample.Criteria;
import org.louis.hometutor.po.CommentExample.Criterion;
...
public class CommentSqlProvider {
    ...
    public String selectByExample(CommentExample example) {
        ...
        SELECT("\"posterId\"");
        SELECT("\"posterType\"");
        SELECT("\"replyTargetId\"");
        SELECT("\"replyTargetType\"");
        SELECT("\"commentTargetId\"");
