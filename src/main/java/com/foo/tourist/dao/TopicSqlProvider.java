...
import org.louis.hometutor.po.TopicExample.Criteria;
import org.louis.hometutor.po.TopicExample.Criterion;
...
public class TopicSqlProvider {
    ...
    public String selectByExample(TopicExample example) {
        ...
        SELECT("\"updatorType\"");
        SELECT("\"answerCount\"");
        SELECT("\"lastReplyTimeStamp\"");
        SELECT("\"lockExpireDate\"");
        SELECT("\"isLock\"");
        SELECT("\"type\"");
        SELECT("\"content\"");
        SELECT("\"title\"");
     ...
     * @mbggenerated
     */
    protected void applyWhere(TopicExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
